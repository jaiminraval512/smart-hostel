<aside class="ad_side">
    <div class="ad_logo">
     <a href="../admin/dashboard.php"><img src="/php/php_/smart-hostel/smart-hostel/assets/images/white_logo.png" alt="Logo"></a>  
    </div>
    <ul>
...
<li>
    <a href="#" >
        <i class="fas fa-file-signature"></i>Leave-Reports</a>
</li>
</li>
    </ul>
</aside>
